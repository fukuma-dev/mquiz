<template>
    <v-card style="text-align: center; box-shadow:none">
        <v-card-text>
            ...
            <v-btn  icon class="ma-2" color="teal" @click.native="stop()" :disabled="!loaded">
                <v-icon class="fas fa-stop"></v-icon>
            </v-btn>
            <v-btn  icon class="ma-2" color="teal" @click.native="mute()" :disabled="!loaded">
                <v-icon v-if="!isMuted" class="fa fa-volume-up"></v-icon>
                <v-icon v-else class="fa fa-volume-mute"></v-icon>
            </v-btn>
            <v-btn  icon class="ma-2" color="teal" @click.native="loaded ? download() : reload()">
